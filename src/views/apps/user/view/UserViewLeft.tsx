      ...
      <Grid item xs={12}>
        <Card>
          <CardContent sx={{ pt: 15, display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
            <CustomAvatar alt='User Image' src='' variant='rounded' sx={{ width: 120, height: 120, mb: 4 }} />
          ...
          <CardContent>
            ...
            <Box sx={{ pt: 2, pb: 1 }}>
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>email@gmail</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  Status:
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>+1 000-00000</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
